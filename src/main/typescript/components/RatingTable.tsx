        ...
        { ratings.map(([player, rating], index) =>
          <Player key={player} color={desaturate(1 - (rating.rating - 1.5 * rating.deviation - minRatingBottom) / (maxRatingBottom - minRatingBottom), '#0082aa')}>
            ...
            <PlayerScoreChart>
              ...
              <ProbableScore widthPercent={getWidthPercent(1.5 * rating.deviation, maxRatingTop)} />
              <PossibleScore widthPercent={getWidthPercent(1.5 * rating.deviation, maxRatingTop)} />
            </PlayerScoreChart>
          </Player>
        )}
    </RatingsContainer>
